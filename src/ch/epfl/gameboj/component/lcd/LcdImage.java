...
public final class LcdImage {
     ...
     * @param lines the image's lines
     * @throws IllegalArgumentException if dimensions are invalid (if either is negative or null)
     * @throws IllegalArgumentException if lines are not of width-length
     */
    ...
    public final class Builder {
         ...
         * @param index line to set (between 0 and height)
         * @param newLine will replace the line at index, must be of the same length
         * @throws IndexOutOfBoundsException if index is negative or bigger than height
         * @throws IllegalArgumentException if line does not have a correct size
         */
     ...
     * @param x horizontal position of pixel starting from the LEFT
     * @param y vertical position of pixel starting from TOP
    ...
    public boolean equals(Object o) {
        if (!(o instanceof LcdImage)) return false;
