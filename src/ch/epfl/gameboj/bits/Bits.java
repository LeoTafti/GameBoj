...
public final class Bits {
    ...
    private static final int[] REVERSED_BYTES = new int[] { 0x00, 0x80, 0x40, 0xC0, 0x20, 0xA0, 0x60,
    ...
    public static int rotate(int size, int bits, int distance) {
        ...
        int distMod = Math.floorMod(distance, size);
        int rotated = clipped << distMod
                | clipped >>> size - distMod;
